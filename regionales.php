...
<html lang="es">
  <head>
    ...
    <title>Noticias Regionales</title>
  </head>
  <body>
                    ...
                    data-bs-target="#menuNavegacion"> 
                        ...
                        <div id="menuNavegacion" class="collapse navbar-collapse">
                          ...
                          <li><a class="dropdown-item active" href="Regionales.php">Regionales</a></li>
                             ...
                             <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle " href="#" role="button" data-bs-toggle="dropdown">ITSPereira</a>
    ...
    <div class="container-fluid">
        <div class="row">
                <div class="col-sm-1">
                  ...
                  <div class="col-sm-5">
                    <div class="card">
                        <img src="turismo.png" class="card-img-top" >
                      <div class="card-body">
                        <h5 class="card-title">Turismo</h5>
                        <p class="card-text">En el proceso de reactivar la economía, el departamento ha demostrado un importante avance en la reapertura del turismo, llegando incluso a superar las cifras de reactivación reportadas a nivel nacional. </p>
                        <a href="turismo.php" class="btn btn-primary">Haz click para ver mas</a>
                      </div>
                    </div>
                  </div>
                  <div class="col-sm-5">
                    <div class="card">
                        <img src="inclu.png" class="card-img-top" >
                      <div class="card-body">
                        <h5 class="card-title">Inclusión</h5>
                        <p class="card-text">En Santa Rosa se han adelantado programas inclusivos para personas con condiciones especiales dentro del municipio. Una muestra de ello es la Casa de la Inclusión, un espacio creado con la intención de brindar atención integral a discapacitados.
</p>
                        <a href="Inclusion.php" class="btn btn-primary">Haz click para ver mas</a>
                      </div>
                    </div>
                  </div>
