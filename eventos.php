...
<body style="background-color: #edeeef;">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-5">
                <div class="card">
                    <img src="feria.png" class="card-img-top">
                    <div class="card-body">
                        <h5 class="card-title">Feria de la Ciencia</h5>
                        <p class="card-text">Ven y conoce sobre la feria de la ciencia de nuestro colegio. La cual se realizo el 19/11/21. </p>
                        <a href="feria.php" class="btn btn-primary">Haz click para ver mas</a>
                    </div>
                </div>
            </div>
            <div class="col-sm-5">
                <div class="card">
                    <img src="deportes.png" class="card-img-top">
                    <div class="card-body">
                        <h5 class="card-title">Deportes</h5>
                        <p class="card-text"> Conoce en que eventos deportivos ha participado nuestra institución.
                        </p>
                        <a href="deportes.php" class="btn btn-primary">Haz click para ver mas</a>
                    </div>
                </div>
            </div>
