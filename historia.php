    ...
    <div class="container-fluid">
        <div class="row">
                <div class="col-sm-1">
                  ...
                  <div class="col-sm-5">
                    <div class="card">
                        <img src="historia.png" class="card-img-top" >
                      <div class="card-body">
                        <h5 class="card-title">Colegio</h5>
                        <p class="card-text">Ven y conoce la historia de nuestra institucion a lo largo de sus 78 años. </p>
                        <a href="colegio.php" class="btn btn-primary">Haz click para ver mas</a>
                      </div>
                    </div>
                  </div>
                  <div class="col-sm-5">
                    <div class="card">
                        <img src="cancha.png" class="card-img-top" >
                      <div class="card-body">
                        <h5 class="card-title">Cancha sintetica</h5>
                        <p class="card-text">Conoce cuando se inaguro la cancha sintetica, ¿cuanto valió? ¿de donde salio el proyecto?.
</p>
